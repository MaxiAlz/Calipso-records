...
const HearoSection = () => {
  return (
    <section className='w-full relative bg-primary text-secondary pt-20 pb-10 md:py-30 '>
      <div className='container mx-auto px-4 flex flex-col-reverse md:flex-row  justify-center lg:justify-around items-center gap-6 md:px-10'>
        ...
        <div className='flex items-center justify-center w-full max-w-sm md:max-w-md lg:max-w-lg lg:ml-20'>
          <img
